...
void slcdErr(uint8_t number){
	...
	switch(number){  //4 digit depends on provided number
		...
		case 0x01:
			...
			break;
		case 0x02:
			LCD->WF8B[LCD_Front_Pin[6]] = (LCD_S_G | LCD_S_D | LCD_S_E );  //TASK 2.5 - replace ZZZ with segment definition
