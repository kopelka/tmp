...
void buttonsInitialize(void){
	...
	//PORTC->PCR[3] |= PORT_PCR_XXX_MASK | PORT_PCR_XXX_MASK; /* TASK 2.9 - enable on PTC3 pull resistor, and choose correct pull option */
	//PORTC->PCR[12] |= PORT_PCR_XXX_MASK | PORT_PCR_XXX_MASK; /* TASK 2.9 - enable on PTC12 pull resistor, and choose correct pull option */
}
/*----------------------------------------------------------------------------
